...
Ce document présente les interactions entre les utilisateurs (Élèves et Bénévoles) et le système pour chaque fonctionnalité majeure, détaillant les responsabilités de chaque acteur.
...
- **Acteurs :** Élève (Restriction sur UC13), Bénévole.
- **Scénario Nominal (Bénévole vers Élève) :**
